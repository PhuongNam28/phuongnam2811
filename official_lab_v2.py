...
cred = credentials.Certificate(".\iuh-20068371-firebase-adminsdk-7y5ou-12c1814cb0.json")
appLoadData = firebase_admin.initialize_app(cred)

dbFireStore = firestore.client()

queryResults = list(dbFireStore.collection(u'tbl-20068371').where(u'DEALSIZE', u'==', 'Large').stream())
